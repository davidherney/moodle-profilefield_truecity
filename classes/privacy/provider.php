...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        return $collection->add_database_table(
            'user_info_data',
            [
                'userid' => 'privacy:metadata:profilefield_truecity:userid',
                'fieldid' => 'privacy:metadata:profilefield_truecity:fieldid',
                'data' => 'privacy:metadata:profilefield_truecity:data',
                'dataformat' => 'privacy:metadata:profilefield_truecity:dataformat',
            ],
            'privacy:metadata:profilefield_truecity:tableexplanation'
        );
    }
